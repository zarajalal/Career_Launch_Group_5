 ...
 * ```
 */
type PublicPagerViewMethods = Omit<PagerViewInternal, 'nativeCommandsWrapper' | 'deducedLayoutDirection' | '_onPageScroll' | '_onPageScrollStateChanged' | '_onPageSelected' | '_onMoveShouldSetResponderCapture'>;
...
} & React.RefAttributes<PublicPagerViewMethods>>;
